...
var syncStartFleetExclusions = map[string]string{
	...
	"analyze-after":                     "cold-start advisory post-copy ANALYZE knob (item 111); not yet curated into the fleet subset",
	...
	"strict-float":                      "VStream FLOAT exact-or-refuse posture; travels with no-float-exact-reread, not yet curated into the fleet subset",
