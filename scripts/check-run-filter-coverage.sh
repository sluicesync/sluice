...
#                      Two packages since the FormatVersion-11 bump: the
#                      pipeline chain-compat suite and the backup package's
#                      positionless-full suite, one leg, one -run filter)
...
crossversion;^TestBackup_CrossVersion;internal/pipeline internal/pipeline/backup;extended-suites.yml crossversion
