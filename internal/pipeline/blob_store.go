...
// Cloud-blob implementation of [irbackup.BackupStore] over `gocloud.dev/blob`.
//
...
// BlobStore is the cloud-backend implementation of [irbackup.BackupStore].
...
// Put implements [irbackup.BackupStore.Put]. Streams r to the named key
...
// Get implements [irbackup.BackupStore.Get]. Returns a streaming reader for
...
// List implements [irbackup.BackupStore.List]. Returns every key whose name
...
// Delete implements [irbackup.BackupStore.Delete]. Idempotent: a missing key
...
// Exists implements [irbackup.BackupStore.Exists]. Returns true iff a blob
...
// Compile-time check that BlobStore satisfies irbackup.BackupStore.
var _ irbackup.BackupStore = (*BlobStore)(nil)
