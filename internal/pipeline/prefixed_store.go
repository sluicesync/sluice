...
// prefixedStore wraps an [irbackup.BackupStore] with a path prefix that's
...
func newPrefixedStore(inner irbackup.BackupStore, prefix string) irbackup.BackupStore {
...
// [irbackup.BackupStore] path convention.
