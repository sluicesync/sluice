...
func readBrokerState(ctx context.Context, store ir.BackupStore, path string) (*brokerState, error) {
...
func writeBrokerState(ctx context.Context, store ir.BackupStore, path string, s *brokerState) error {
...
func writeBrokerStateMergeHeartbeat(ctx context.Context, store ir.BackupStore, path string, s *brokerState) (stopObserved bool, err error) {
...
// file is (nil, nil).
func readBrokerStopRequested(ctx context.Context, store ir.BackupStore, path string) (*time.Time, error) {
...
func RequestSyncFromBackupStop(ctx context.Context, store ir.BackupStore, now time.Time) (*brokerState, error) {
...
func requestBrokerStopAt(ctx context.Context, store ir.BackupStore, path string, now time.Time) (*brokerState, error) {
	prior, err := readBrokerState(ctx, store, path)
	if err != nil {
