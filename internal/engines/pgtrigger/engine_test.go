...
func TestRenderSetupDDL_EventTriggerToggle(t *testing.T) {
	withET := renderSetupDDL("public", []tableTriggerSpec{{Name: "orders", PKCols: []string{"id"}}}, true, false, CapturePayloadFull, false, nil)
	withoutET := renderSetupDDL("public", []tableTriggerSpec{{Name: "orders", PKCols: []string{"id"}}}, false, false, CapturePayloadFull, false, nil)
