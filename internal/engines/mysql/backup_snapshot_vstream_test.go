...
// [irbackup.TableScopedBackupSnapshotOpener] surface, so the backup orchestrator
...
var _ irbackup.TableScopedBackupSnapshotOpener = Engine{Flavor: FlavorPlanetScale}
