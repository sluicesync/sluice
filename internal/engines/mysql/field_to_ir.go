...
//
// What IS bound in-code (2026-08-23, the premise-check pass): this constant
// and its consumption are held to the CARRIER'S OWN vocabulary by
// TestMySQLFlagAutoIncrementBoundToVitessCarrier — sluice's 512 must equal
// the vendored querypb.MySqlFlag_AUTO_INCREMENT_FLAG, and a field flagged
// with that enum value must flip [vstreamTinyint1IsBool] through the real
