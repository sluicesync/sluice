...
func TestDecodeBinlogRow(t *testing.T) {
	...
	row, err := decodeBinlogRow(raw, cols, nil, FlavorVanilla, "users", zeroDateInherit, binlogLabelGuard{}, nil)
	if err != nil {
...
func TestDecodeBinlogRow_TinyInt1OutOfRangeRefuses(t *testing.T) {
	...
	_, err := decodeBinlogRow([]any{int64(1), int64(2)}, cols, nil, FlavorVanilla, "users", zeroDateInherit, binlogLabelGuard{}, nil)
	if err == nil {
	...
	row, err := decodeBinlogRow([]any{int64(3), int64(1)}, cols, nil, FlavorVanilla, "users", zeroDateInherit, binlogLabelGuard{}, nil)
	if err != nil {
...
func TestDecodeBinlogRowColumnCountMismatch(t *testing.T) {
	...
	if _, err := decodeBinlogRow([]any{int64(1), int64(2)}, cols, nil, FlavorVanilla, "t", zeroDateInherit, binlogLabelGuard{}, nil); err == nil {
