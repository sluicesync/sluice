...
// MySQL dialect definitions for identifier re-quoting. The mechanism
// that consumes these sets lives in the shared
// internal/translate/exprident package (ADR-0045); the sets stay here
// because they are MySQL dialect definitions, correctly engine-owned.
// requoteMySQLReservedIdents (the thin wrapper) is in
// exprident_shared.go.
