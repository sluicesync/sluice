...
func TestPipelined_ValueFidelity_Matrix(t *testing.T) {
	...
	cols := []arrayCol{
		...
		{"a_mac2", "MACADDR[]", []any{[]any{"08:00:2b:01:02:03", "08:00:2b:01:02:04"}, []any{"08:00:2b:01:02:05", "08:00:2b:01:02:06"}}, "[1:2][1:2]", "{{08:00:2b:01:02:03,08:00:2b:01:02:04},{08:00:2b:01:02:05,08:00:2b:01:02:06}}"},
		{"a_macn", "MACADDR[]", []any{"08:00:2b:01:02:03", nil, "08:00:2b:01:02:05"}, "[1:3]", "{08:00:2b:01:02:03,NULL,08:00:2b:01:02:05}"},
		// macaddr8 is its own family here, not a macaddr variant: pgx ships
		// no `macaddr8[]` codec, so sluice registers one (roadmap item 117).
		// A hand-registered per-OID array codec is the Bug 74 shape exactly,
		// and ≥2-D is the cell that silently flattened that time.
		{"a_mac81", "MACADDR8[]", []any{"08:00:2b:ff:fe:01:02:03", "08:00:2b:ff:fe:01:02:04"}, "[1:2]", "{08:00:2b:ff:fe:01:02:03,08:00:2b:ff:fe:01:02:04}"},
		{"a_mac82", "MACADDR8[]", []any{[]any{"08:00:2b:ff:fe:01:02:03", "08:00:2b:ff:fe:01:02:04"}, []any{"08:00:2b:ff:fe:01:02:05", "08:00:2b:ff:fe:01:02:06"}}, "[1:2][1:2]", "{{08:00:2b:ff:fe:01:02:03,08:00:2b:ff:fe:01:02:04},{08:00:2b:ff:fe:01:02:05,08:00:2b:ff:fe:01:02:06}}"},
		{"a_mac8n", "MACADDR8[]", []any{"08:00:2b:ff:fe:01:02:03", nil, "08:00:2b:ff:fe:01:02:05"}, "[1:3]", "{08:00:2b:ff:fe:01:02:03,NULL,08:00:2b:ff:fe:01:02:05}"},
