...
func TestNetworkRendering_BothLegsAgree_AndMatchTheDeclaredRendering(t *testing.T) {
	...
	tbl := &ir.Table{
		...
		Columns: []*ir.Column{
			...
			{Name: "v4_host", Type: ir.Inet{Family: ir.InetFamilyAny}},
			{Name: "v6_host", Type: ir.Inet{Family: ir.InetFamilyAny}},
			{Name: "v4_net", Type: ir.Inet{Family: ir.InetFamilyAny}},
			{Name: "v6_net", Type: ir.Inet{Family: ir.InetFamilyAny}},
			{Name: "c4_host", Type: ir.Cidr{Family: ir.InetFamilyAny}},
			{Name: "c4_net", Type: ir.Cidr{Family: ir.InetFamilyAny}},
			{Name: "c6_net", Type: ir.Cidr{Family: ir.InetFamilyAny}},
			{Name: "v6_compat", Type: ir.Inet{Family: ir.InetFamilyAny}},
			{Name: "v6_high", Type: ir.Inet{Family: ir.InetFamilyAny}},
		},
	}
