...
// slackText renders a Notification as a single readable line, e.g.
// ":rotating_light: [sluice s1] storage_util 0.91 ≥ 0.90 — target storage
// approaching capacity". The emoji encodes the level (rotating light for
// critical, warning sign otherwise).
