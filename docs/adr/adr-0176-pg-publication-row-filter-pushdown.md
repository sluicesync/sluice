...
**Implemented (chunk 2, the push-down itself) 2026-07-23 — released v0.99.290.** Shipped as decided (§1–§4), with the fallback mechanism landing in the same change as the first enabled cell, per §4's ordering rule:
