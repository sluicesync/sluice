...
Status: **Accepted** (2026-07-09; decisions §3/§4/§7 ratified by the operator — build in the §6 phased order, Phase 1 first). **Phase 1 shipped (v0.99.208); Phase 2 (Ed25519) implemented (unreleased)** — see §8 / §9.
Date: 2026-07-09
