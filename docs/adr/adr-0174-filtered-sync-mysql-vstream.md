...
**Proposed (2026-07-17).** Extends ADR-0173 (row-level `--where`). Closes the two gaps that live testing of the region-split use case surfaced: continuous `sync --where` refuses on MySQL-family sources for two distinct reasons, and this ADR makes it *work* — faithfully — rather than refuse.
