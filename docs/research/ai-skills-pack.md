...
4. **Do the skills belong in this repo or a sibling `sluicesync/skills` repo?** (PlanetScale chose a dedicated repo; in-repo keeps them versioned with the CLI they drive — recommend in-repo `skills/` for the doc-sync coupling.)
