...
>
> **FIXED in [v0.73.2](https://github.com/orware/sluice/releases/tag/v0.73.2) — upgrade strongly recommended.** MySQL → MySQL Shape A on v0.73.1 was working end-to-end and is unchanged.
...
- [Bug 83 cycle session report (orware/sluice-testing)](https://github.com/orware/sluice-testing/blob/main/session-reports/v0.73.0.md)
