...
- **Operators running sluice's own integration suite locally** — the pre-baked image work eliminates ~30-60s of per-test container boot on every shard plus the docker.io TLS-handshake-timeout flake class.
