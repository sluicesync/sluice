...
- **End-to-end validation deferred to operator re-test** — the local validation rig has the 4-table chain that can be pruned + restored to verify the re-stitch + restore-side behavior.
